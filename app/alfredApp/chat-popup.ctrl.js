app.controller('chatPopupCtrl',['$window','$scope','chatService',function($window,$scope,chatService) {
    var vm = this;
    ...
    vm.init=function(){
        ...
        /*store it in a servce var*/
        chatService.setIsMobile(window.mobilecheck());    
    }

    /*check whether its a browser or mobile*/
